...
2) **Weaponization** - Preparatory activities aimed at settin gup the infrastructure required for the attack.
...
7) **Defence Evasion** - Techniques an attacker may specifically use for evading detection or avoiding other defenses.
